...
public class MockPolicyV3 {
     ...
     */
    protected final MockPolicyConfiguration mockPolicyConfiguration;

    public MockPolicyV3(MockPolicyConfiguration mockPolicyConfiguration) {
    ...
    class MockClientResponse implements ProxyResponse {
        ...
        private void init(ExecutionContext executionContext, EvaluableRequest request) {
                            ...
                            public void accept(HttpHeader header) {
                                try {
                                    String extValue = (header.getValue() != null)
                                        ? executionContext.getTemplateEngine().evalNow(header.getValue(), String.class)
                                        : null;
                                    if (extValue != null) {
            ...
            if (hasContent) {
                ...
                try {
                    evaluatedContent = executionContext.getTemplateEngine().evalNow(content, String.class);
